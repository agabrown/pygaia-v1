...
from pygaiav1.errors.astrometric import parallaxErrorSkyAvg
from pygaiav1.errors.astrometric import parallaxMinError, parallaxMaxError
from pygaiav1.photometry.utils import vminiFromSpt
