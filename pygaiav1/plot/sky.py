...
from pygaiav1.astrometry.coordinates import Transformations, CoordinateTransformation
from pygaiav1.utils import degreesToRadians, radiansToDegrees
...
def plotCoordinateTransformationOnSky(transformation, outfile=None, noTitle=False, noLabels=False,
    ...
    pygaiav1.coordinates.Transformations enum. For example for Transformations.GAL2ECL the sky plot will be
